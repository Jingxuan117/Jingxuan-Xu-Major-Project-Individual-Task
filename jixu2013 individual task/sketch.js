//The code changes include optimizations and simplifications compared to the group code, 
//mainly including removing random offsets in position and color, eliminating some unused variables, 
//and simplifying the drawing functions. 
//These changes provide a more stable and structured foundation for the following use of Perlin noise to achieve the animation, 
//and simplify attribute control and position management,
//making it easier to implement more natural and smooth dynamic effects in the final prototype animation with perlin noise.
